class Gtab < Formula
  ...
  on_arm do
    url "https://github.com/Franvy/gtab/releases/download/v1.4.3/gtab-1.4.3-aarch64-apple-darwin.tar.gz"
    sha256 "0970468525285e15154e141e7bd846159f946c95f247249137f908f9ac057b3a"
  end
