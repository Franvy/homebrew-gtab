class Gtab < Formula
  ...
  on_arm do
    url "https://github.com/Franvy/gtab/releases/download/v1.5.0/gtab-1.5.0-aarch64-apple-darwin.tar.gz"
    sha256 "43fc26e12ecd7f572380f49399f9aa312e49ede8878ce890038584be3550ef92"
  end
