class Gtab < Formula
  ...
  on_arm do
    url "https://github.com/Franvy/gtab/releases/download/v1.4.1/gtab-1.4.1-aarch64-apple-darwin.tar.gz"
    sha256 "f8b9bfaa5d2f152dacae373ede6c019481499eeb1a43c30d4aa42770e225fe76"
  end
