class Gtab < Formula
  ...
  on_arm do
    url "https://github.com/Franvy/gtab/releases/download/v1.4.2/gtab-1.4.2-aarch64-apple-darwin.tar.gz"
    sha256 "baefed482eb3a85c6bbf8138bd0241d84b5ef6597a51fa293a443d636fc6c7fd"
  end
